...
class AnalyzeService(object):
    ...
    def Apply(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/types.AnalyzeService/Apply',
            analyze__pb2.AnalyzeRequest.SerializeToString,
            analyze__pb2.AnalyzeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def GetAllRecognizers(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/types.AnalyzeService/GetAllRecognizers',
            analyze__pb2.RecognizersAllRequest.SerializeToString,
            analyze__pb2.RecognizersAllResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
